...
public class Lesson13_E : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cameraFollow.transform.LookAt(this.transform.position);
        if (Input.GetMouseButton(1))
        {
            cameraFollow.transform.RotateAround(this.transform.position, Vector3.up, Input.GetAxis("Mouse X") * Time.deltaTime * 200);
